...
using Tyuiu.SafronovSV.Sprint4.Task4.V30.Lib;

namespace Tyuiu.SafronovSV.Sprint4.Task4.V30
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Title = "Спринт #4 | Выполнил: Сафронов С. В. | АСОиУб23-2 ";
            Console.WriteLine("***************************************************************************");
            Console.WriteLine("* Спринт #4                                                               *");
            Console.WriteLine("* Двумерные массивы. (ввод с клавиатуры)                                  *");
            Console.WriteLine("* Задание #4                                                              *");
            Console.WriteLine("* Вариант #30                                                             *");
            Console.WriteLine("* Выполнил: Сафронов Сергей Владимирович | АСОиУб23-2                          *");
            Console.WriteLine("***************************************************************************");
